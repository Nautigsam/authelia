...
describe("src/lib/DomainExtractor", function () {
  describe("test fromUrl", function () {
    ...
    it("should return domain when url contains port", function () {
      ...
      Assert.equal(domain, "www.example.com:8080");
    });
